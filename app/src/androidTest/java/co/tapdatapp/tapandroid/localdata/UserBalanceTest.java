...
public class UserBalanceTest extends BaseUnitTest {
    ...
    private void removeAllRecords() {
        ...
        db.delete(CurrencyDAO.TABLE, null, null);
    }
    ...
    public void testCreateOrUpdate_create() {
        ...
        final String symbol = "$";
        final int maxTap = 5;
        b.createOrUpdate(id, name, icon, symbol, maxTap, false);
        b = new CurrencyDAO();
        b.moveTo(id);
    ...
    public void testCreateOrUpdate_update() {
        ...
        b.createOrUpdate(id, name0, icon0, symbol0, 0, false);
        b = new CurrencyDAO();
        b.createOrUpdate(id, name1, icon1, symbol1, 0, false);
        b = new CurrencyDAO();
        b.moveTo(id);
    ...
    public void testUpdateAllDenominations_create() {
        ...
        b.createOrUpdateAll(id, name, icon, symbol, 0, false, d);
        b = new CurrencyDAO();
        b.moveTo(id);
        assertEquals("name did not match", name, b.getName());
        assertEquals("icon URL did not match", icon, b.getIconUrl());
    ...
    public void testUpdateAllDenominations_deleteDenominations() {
        ...
        b.createOrUpdateAll(id, name, icon, symbol, 0, false, d);
        b = new CurrencyDAO();
        b.createOrUpdateAll(id, name, icon, symbol, 0, false, null);
        b = new CurrencyDAO();
        b.moveTo(id);
        assertEquals("name did not match", name, b.getName());
        assertEquals("icon URL did not match", icon, b.getIconUrl());
    ...
    public void testGetIconFromCache() throws Exception {
        ...
        final String symbol = "$";
        CurrencyDAO b = new CurrencyDAO();
        b.createOrUpdate(id, name, icon, symbol, 0, false);
