...
public class YapaAudio extends Activity{
    ...
    public void onCreate(Bundle state) {
        ...
        /**
         * This is going to need testing and will probably be changed in the future
         */
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent openAudio = new Intent(Intent.ACTION_VIEW, Uri.parse(transaction.getYapa_url()));
                openAudio.setDataAndType(Uri.parse(transaction.getYapa_url()),"audio/*");
